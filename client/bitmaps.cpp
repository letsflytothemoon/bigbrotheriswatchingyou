...
std::vector<unsigned char> CreateBMPFile(HDC hDC, HBITMAP hBMP)
{
    ...
    memcpy(lpBits, pbih, sizeof(BITMAPINFOHEADER) + pbih->biClrUsed * sizeof(RGBQUAD));
    lpBits += sizeof(BITMAPINFOHEADER) + pbih->biClrUsed * sizeof(RGBQUAD);
